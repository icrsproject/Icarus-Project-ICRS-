#############################################################################
# Makefile for building: icarus-qt
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  Icarus-qt.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile Icarus-qt.pro RELEASE=1
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = icarus-qt1.0.7
DISTDIR = /tmp/Icarus/build/icarus-qt1.0.7
LINK          = g++
LFLAGS        = -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -Wl,-Bstatic -lminiupnpc /tmp/Icarus/src/leveldb/libleveldb.a /tmp/Icarus/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lQt5Widgets -lQt5Gui -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		Icarus-qt.pro src/qt/bitcoingui.h \
...
$(TARGET): /tmp/Icarus/src/leveldb/libleveldb.a /tmp/Icarus/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Icarus-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Icarus-qt.pro RELEASE=1
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /tmp/Icarus/src/leveldb/libleveldb.a; cd /tmp/Icarus/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/tmp/Icarus/src/leveldb/libleveldb.a: FORCE
	cd /tmp/Icarus/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/Icarus/build/build.h: FORCE
	cd /tmp/Icarus; /bin/sh share/genbuild.sh /tmp/Icarus/build/build.h
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h \
		build/moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include build/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/tmp/Icarus -I/tmp/Icarus/src -I/tmp/Icarus/src/json -I/tmp/Icarus/src/qt -I/tmp/Icarus/src/leveldb/include -I/tmp/Icarus/src/leveldb/helpers -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/x86_64-linux-gnu/c++/7 -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-linux-gnu/7/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/7/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
